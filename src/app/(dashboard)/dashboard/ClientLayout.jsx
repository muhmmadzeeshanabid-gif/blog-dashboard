...
export default function ClientLayout({ children, initialNotifications, initialUnreadCount }) {
  ...
  return (
    <DashboardAuthWrapper>
      <NotificationsProvider initialNotifications={initialNotifications} initialUnreadCount={initialUnreadCount}>
