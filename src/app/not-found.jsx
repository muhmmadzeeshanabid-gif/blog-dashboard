...
export const metadata = {
  ...
  description:
    "Oops! The page you are looking for does not exist. It may have been moved or deleted. Return to the ORIN homepage to find what you need.",
  robots: {
    index: false,
    follow: false,
    nocache: true,
  ...
  openGraph: {
    title: "404 — Page Not Found | ORIN",
    description:
      "The page you are looking for does not exist. Go back to the ORIN homepage.",
    type: "website",
    siteName: "ORIN",
  },
  twitter: {
