...
export function NotificationsProvider({ children }) {
  ...
  const refresh = async () => {
    try {
      ...
      if (res.ok) {
        ...
        const readIds = getCookieJson("orin_read_notifications");
        const clearedIds = getCookieJson("orin_cleared_notifications");
  ...
  const markAsRead = (id) => {
    ...
    setCookieJson("orin_read_notifications", nextReadIds);
  ...
  const clearAll = () => {
    ...
    setCookieJson("orin_cleared_notifications", nextClearedIds);
